    ...
    require '../../database.php';
     ...
     if ( !empty($_POST)) {
        ...
        if ($valid) {
			...
			$q->bindParam(':asas', $user_password);
			$q->execute();
 ...
 <body>
	 <div class="container">
				...
				<div class="span10 offset1">
                    ...
                    <form class="form-horizontal" action="/students_development2/test/students_development2/pages/students/students.php" method="post">
